...
def get_db_connection():
    ...
    try:
        ...
        # Aseguramos que el texto se maneje correctamente como cadenas de Python (útil para CSVs)
...
def load_data(conn):
    ...
    # La carga se hace con 'replace' para asegurar que el mapeo 1=Lineal, 2=RF siempre esté correcto.
    modelo_data.to_sql('modelo', conn, if_exists='replace', index=False)
